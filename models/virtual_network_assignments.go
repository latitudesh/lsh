...
func (m *VirtualNetworkAssignments) validateData(formats strfmt.Registry) error {
...
func (m *VirtualNetworkAssignments) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VirtualNetworkAssignments) UnmarshalBinary(b []byte) error {
	var res VirtualNetworkAssignments
