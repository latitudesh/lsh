...
func (m *LazySideload) validateMeta(formats strfmt.Registry) error {
...
func (m *LazySideload) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
