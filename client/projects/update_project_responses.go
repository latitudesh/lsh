...
func (o *UpdateProjectNotFound) Error() string {
	return fmt.Sprintf("[PATCH /projects/{id_or_slug}][%d] updateProjectNotFound  %+v", 404, o.Payload)
}
...
func (o *UpdateProjectNotFound) GetPayload() *models.ErrorObject {
	return o.Payload
}
...
func (o *UpdateProjectUnprocessableEntity) Error() string {
	return fmt.Sprintf("[PATCH /projects/{id_or_slug}][%d] updateProjectUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *UpdateProjectUnprocessableEntity) GetPayload() *models.ErrorObject {
	return o.Payload
}
