...
func NewPutProjectSSHKeyBadRequest() *PutProjectSSHKeyBadRequest {
	return &PutProjectSSHKeyBadRequest{}
}
...
Bad Request
*/
type PutProjectSSHKeyBadRequest struct {
}

// IsSuccess returns true when this put project Ssh key bad request response has a 2xx status code
func (o *PutProjectSSHKeyBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this put project Ssh key bad request response has a 3xx status code
func (o *PutProjectSSHKeyBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this put project Ssh key bad request response has a 4xx status code
func (o *PutProjectSSHKeyBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this put project Ssh key bad request response has a 5xx status code
func (o *PutProjectSSHKeyBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this put project Ssh key bad request response a status code equal to that given
func (o *PutProjectSSHKeyBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the put project Ssh key bad request response
func (o *PutProjectSSHKeyBadRequest) Code() int {
	return 400
}

func (o *PutProjectSSHKeyBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /projects/{project_id_or_slug}/ssh_keys/{ssh_key_id}][%d] putProjectSshKeyBadRequest ", 400)
}

func (o *PutProjectSSHKeyBadRequest) String() string {
	return fmt.Sprintf("[PATCH /projects/{project_id_or_slug}/ssh_keys/{ssh_key_id}][%d] putProjectSshKeyBadRequest ", 400)
}

func (o *PutProjectSSHKeyBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	return nil
}

// NewPutProjectSSHKeyUnprocessableEntity creates a PutProjectSSHKeyUnprocessableEntity with default headers values
func NewPutProjectSSHKeyUnprocessableEntity() *PutProjectSSHKeyUnprocessableEntity {
	return &PutProjectSSHKeyUnprocessableEntity{}
}
...
*/
type PutProjectSSHKeyUnprocessableEntity struct {
}

// IsSuccess returns true when this put project Ssh key unprocessable entity response has a 2xx status code
func (o *PutProjectSSHKeyUnprocessableEntity) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this put project Ssh key unprocessable entity response has a 3xx status code
func (o *PutProjectSSHKeyUnprocessableEntity) IsRedirect() bool {
	return false
}

// IsClientError returns true when this put project Ssh key unprocessable entity response has a 4xx status code
func (o *PutProjectSSHKeyUnprocessableEntity) IsClientError() bool {
	return true
}

// IsServerError returns true when this put project Ssh key unprocessable entity response has a 5xx status code
func (o *PutProjectSSHKeyUnprocessableEntity) IsServerError() bool {
	return false
}

// IsCode returns true when this put project Ssh key unprocessable entity response a status code equal to that given
func (o *PutProjectSSHKeyUnprocessableEntity) IsCode(code int) bool {
	return code == 422
}

// Code gets the status code for the put project Ssh key unprocessable entity response
func (o *PutProjectSSHKeyUnprocessableEntity) Code() int {
	return 422
}

func (o *PutProjectSSHKeyUnprocessableEntity) Error() string {
	return fmt.Sprintf("[PATCH /projects/{project_id_or_slug}/ssh_keys/{ssh_key_id}][%d] putProjectSshKeyUnprocessableEntity ", 422)
}

func (o *PutProjectSSHKeyUnprocessableEntity) String() string {
	return fmt.Sprintf("[PATCH /projects/{project_id_or_slug}/ssh_keys/{ssh_key_id}][%d] putProjectSshKeyUnprocessableEntity ", 422)
}

func (o *PutProjectSSHKeyUnprocessableEntity) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
