...
func (a *Client) GetRegion(params *GetRegionParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetRegionOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for get-region: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) GetRegions(params *GetRegionsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetRegionsOK, error) {
	...
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for get-regions: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
