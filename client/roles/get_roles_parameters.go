...
// WithAPIVersion adds the aPIVersion to the get roles params
func (o *GetRolesParams) WithAPIVersion(aPIVersion *string) *GetRolesParams {
	o.SetAPIVersion(aPIVersion)
	return o
}

// SetAPIVersion adds the apiVersion to the get roles params
func (o *GetRolesParams) SetAPIVersion(aPIVersion *string) {
