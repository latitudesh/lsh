...
// NewPostTeamMembersParams creates a new PostTeamMembersParams object,
...
func NewPostTeamMembersParams() *PostTeamMembersParams {
	return &PostTeamMembersParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewPostTeamMembersParamsWithTimeout creates a new PostTeamMembersParams object
...
// NewPostTeamMembersParamsWithContext creates a new PostTeamMembersParams object
...
// NewPostTeamMembersParamsWithHTTPClient creates a new PostTeamMembersParams object
...
func (o *PostTeamMembersParams) WithContext(ctx context.Context) *PostTeamMembersParams {
	o.SetContext(ctx)
	return o
}
...
// WithAPIVersion adds the aPIVersion to the post team members params
func (o *PostTeamMembersParams) WithAPIVersion(aPIVersion *string) *PostTeamMembersParams {
	o.SetAPIVersion(aPIVersion)
	return o
}

// SetAPIVersion adds the apiVersion to the post team members params
func (o *PostTeamMembersParams) SetAPIVersion(aPIVersion *string) {
	o.APIVersion = aPIVersion
}

// WithBody adds the body to the post team members params
func (o *PostTeamMembersParams) WithBody(body PostTeamMembersBody) *PostTeamMembersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post team members params
func (o *PostTeamMembersParams) SetBody(body PostTeamMembersBody) {
	o.Body = body
}
